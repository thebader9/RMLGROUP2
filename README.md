...
**Data Dictionary:**
 ...
 |:--------------------------:|:------:|:--------------:|:---------------------------------------------: |                          
 |debt_to_income_ratio_std    |Input   |Numeric         |Standardized debt-to-income ratio<br>for mortgage applicants|                                                                                                  |debt_to_income_ratio_missing |Input   |Binary numeric  |Missing marker (1) for debt to income ratio std  |
