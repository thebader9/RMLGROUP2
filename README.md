...
* **In PiML we use 'Model fairness'to measure model fairness using the Adverse Impact Ratio (AIR).The general threshold for AIR is 0.8.There are multiple methods in PiML to adjust for AIR,such as segmenting, thresholding, binning and feature removal. In this case we opted to use the .......................... method.**
